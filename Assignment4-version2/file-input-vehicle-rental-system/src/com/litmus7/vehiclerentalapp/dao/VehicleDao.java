...
public class VehicleDao {
	...
	public List<Vehicle> loadVehiclesFromFile(String filePath) throws VehicleDataAccessException {
		...
		if (!file.exists()) {
			throw new VehicleDataAccessException("File not found: " + file, null);
		}
		...
		try (BufferedReader br = new BufferedReader(new FileReader(file))) {
			...
			throw new VehicleDataAccessException("Error reading vehicle data file", e);
		}
	 ...
	 */
	public void saveVehicleToFile(List<Vehicle> vehicleList, String filePath) throws VehicleDataAccessException {
		try (BufferedWriter bw = new BufferedWriter(new FileWriter(filePath))) {
			...
			throw new VehicleDataAccessException("Error saving file: ", e);
		}
	}
}
