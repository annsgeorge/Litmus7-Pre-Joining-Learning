...
public class VehicleController {
	 ...
	 */
	public Response<Object> handleDataLoadingFromFile() {
	...
	public Response checkAvailability() {
		...
		availableList = vehicleService.hasAvailableVehicles();

		Response<Object> rentResponse = new Response<Object>();
		if (availableList.size() != 0) {
			// Vehicles available to rent
			rentResponse.setStatusCode(SUCCESS_STATUS_CODE);
			rentResponse.setData(availableList);
		} else {
	 ...
	 */
	public Response<Object> controlAddVehicle(Vehicle v) {
		Response<Object> addResponse = new Response<Object>();
		try {
	 ...
	 */
	public Response controlSearch(String searchKey) {
		Response searchResponse = new Response<>();
		List<Object> searchList;
		searchList = vehicleService.searchVehicle(searchKey);

		if (searchList.size() != 0) {
			searchResponse.setStatusCode(SUCCESS_STATUS_CODE);
			searchResponse.setData(searchList);
		} else {
