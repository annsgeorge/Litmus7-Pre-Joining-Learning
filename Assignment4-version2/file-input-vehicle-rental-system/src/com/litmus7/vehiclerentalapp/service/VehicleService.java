...
public class VehicleService {
	 ...
	 */
	public List loadDataFromDao(String filepath) throws VehicleDataAccessException {
		try {
	 ...
	 */
	public List addVehicle(Vehicle v, String filePath) throws VehicleDataAccessException {
	 ...
	 */
	public List searchVehicle(String searchKey) {
	 ...
	 */
	public List hasAvailableVehicles() {
		boolean rented = true;
		System.out.println("\nDetails of available vehicles:\n");
		int i = 1;
		for (Vehicle v : vehicleList) {
			if (v.isAvailable()) {
				availableList.add(v); // Only add available vehicles
				System.out.print("[" + i + "] ");
