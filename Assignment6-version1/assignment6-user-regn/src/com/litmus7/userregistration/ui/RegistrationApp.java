...
/**
 * Entry point for the User Registration application.
 * 
 * <p>
 * This class handles user input from the console, invokes the controller layer
 * for registration logic, and displays the result back to the user.
 * </p>
 */
